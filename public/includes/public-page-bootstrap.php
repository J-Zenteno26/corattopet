...
function renderPublicPageStart(string $title, string $description, string $currentPage): void
{
    $GLOBALS['currentPage'] = $currentPage;
    ?><!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="description" content="<?= e($description) ?>"><title><?= e($title) ?></title><link rel="canonical" href="<?= e(appUrl('public/' . basename((string) ($_SERVER['SCRIPT_NAME'] ?? 'index.php')))) ?>"><link rel="stylesheet" href="<?= e(appUrl('public/assets/css/home.css')) ?>"><link rel="stylesheet" href="<?= e(appUrl('public/assets/css/public-pages.css?v=' . filemtime(__DIR__ . '/../assets/css/public-pages.css'))) ?>"></head><body class="public-page"><?php
