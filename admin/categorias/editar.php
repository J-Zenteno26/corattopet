...
<?php else: ?>
<?php if ($errors !== [] || $generalError): ?><div class="admin-alert admin-alert--error" role="alert"><strong>No fue posible actualizar la categoría.</strong><?php if ($generalError): ?><p><?= escape($generalError) ?></p><?php endif; ?><ul><?php foreach ($errors as $error): ?><li><?= escape((string) $error) ?></li><?php endforeach; ?></ul></div><?php endif; ?>
